...
print("Wyatt Lynch")
# problem 2. In the array.py create an array named 'cars' 
# with the following elements in this order  ---- Ford,
# Chrysler,Dodge,Ram,Jeep,Chevy,GMC` (use single quotes for 
# each element)EX: 'Ford' not "Ford" spelling matters
...
print(cars)
# `problem 16. create a variable called
#  my_array_length with a value of the cars array
#  length (spelling, capitilization, and spaces
#  matter)`
my_array_length = len(cars)
# `problem 17. create a variable called
#  array_string with a value of 'The length of my
#  array is ' (spelling, capitilization, and spaces
#  matter)`
array_string = 'The length of my array is '
# `problem 18. print array_string concatenated with
#  my_array_length to the console.`
...
print('==========================')
element = 1
for car in cars:  #len(cars)=8     #len of the list for (i=0, i<cars.len, i++)
    print(element, car)
    element += 1 # element is = element + 1 